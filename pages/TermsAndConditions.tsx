  ...
  return (
    <Layout>
      <Section className="bg-gradient-hero">
        ...
        >
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-accent mb-4">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="space-y-2 text-muted-foreground mb-8">
                ...
                <li>
                  <strong className="text-foreground">Country</strong> refers to: California, United States
                </li>
                <li>
                  <strong className="text-foreground">Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to isawebdev.com.
                </li>
                <li>
                ...
                <li>
                  <strong className="text-foreground">Website</strong> refers to isawebdev.com, accessible from <a href="https://isawebdev.com/" rel="external nofollow noopener" target="_blank">https://isawebdev.com/</a>
                </li>
                <li>
            ...
            <section className="border-t border-border pt-8">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>By email: support@isawebdev.com</li>
                <li>By phone: +1 (415) 533‑8027</li>
              </ul>
            </section>
          </div>
        </motion.div>
